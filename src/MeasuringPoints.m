...
% MeasuringPoints - This function identifies the Y and X indexes and their angle of 16 or 4
%                   measuring points located at a specied radiues from the source
% Input: radius - distance to release site
%        source - release site
%        M - Image size
%        ds - pixel size
%        op - type of analysis identifier
% Output: MPfinal - The Y and X indexes of the measuring points
%         Anglesfinal - The corresponding angle to each measuring point. 
